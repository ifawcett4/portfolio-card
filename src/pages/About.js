      ...
      <div className="about">
          ...
          <div className="main">
            ...
            <div className="about-main-right">
              ...
              <p className="body-text">
                ...
                (currently finishing BG3), photography, fantasy books, and I'm
        ...
        <div className="section">
          <div className="skills">
            ...
            <p className="body-text">
              {" "}
              My current role is Social AR Lead at Paradowski Creative at which
              I have been expoloring AR and immersive technology at since my
              internship in 2021. I graduated with a B.F.A in Interactive Design
              from Maryville University of Saint Louis 2021. As a generalist I
              have experience with a variety of tools with a primary focus on AR
              and Front end Web Dev languages.
            </p>
            <p className="box-text skills-text">
              {" "}
              XR | AR | Lens Studio (Snapchat) | Effect House (Tik Tok) | Meta
              Spark (Instagram) | 8th Wall | PlayCanvas | Web Development |
              JavaScript | HTML | CSS | React | Three.js | Aframe.js | Node.js |
              Git | Blender | Adobe Illustrator | Adobe Photoshop | Figma |
              Design | Creative Concepting | Research and Development | Game Dev
              | Unity | Godot{" "}
            </p>
          </div>
        </div>
